...
⚙️ **Completely Customizable:** You can customize the content, speed, colors, etc to make it suitable for your website design
...
- To report issue and contribution visit [Github](https://github.com/EssentialBlocks/instagram-block/).
- If you have any more questions, visit our support on the [Plugin's Forum](https://wordpress.org/support/plugin/instagram-block/).
...
🧡 LOVED Instagram Block? Rate us on [WordPress Repository](https://wordpress.org/support/plugin/instagram-block/reviews/#new-post)
...
= Old Way: =
1. Upload `instagram-block` to the `/wp-content/plugins/` directory
